...
class VehicleAdmin {
    ...
    VehicleAdmin(Context context) {
        _appContext = context;
    }

    void addNewVehicleIfValid(VehicleInfoStruct newVehicle) {
    ...
    ArrayList<VehicleInfoStruct> getVehicleList() {
        DatabaseMain database = new DatabaseMain(_appContext);
        SQLiteDatabase db = database.getReadableDatabase();
    ...
    VehicleInfoStruct getVehicleByPK(String vehiclePK) {
        DatabaseMain database = new DatabaseMain(_appContext);
        SQLiteDatabase db = database.getReadableDatabase();
    ...
    void updateVehicleInfo(VehicleInfoStruct updatedVehicleInfo) {
